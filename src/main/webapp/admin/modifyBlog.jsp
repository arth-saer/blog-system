			...
			function submitBlog(){
				...
				if(title == null || title == ''){
					...
					$.post("${pageContext.request.contextPath}/admin/blog/save.action",
						{"id":${param.id}, "title":title, "typeId":typeId, "content":content, "contentNoTag":contentNoTag,
...
<table cellspacing="20px">
	...
	<tr>
		<td></td>
		<td><a href="javascript:submitBlog()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">修改博客</a></td>
	</tr>
</table>
</div>
